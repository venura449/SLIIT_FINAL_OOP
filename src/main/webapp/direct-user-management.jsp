...
<%@ page import="java.io.*" %>
<%@ page import="com.config.DBConfig" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <%!
        ...
        private static final String USERS_FILE = DBConfig.USERS_FILE;
    ...
    <%
        ...
        String adminPassword = "123"; // Set the admin password
        ...
        if (enteredPassword != null && enteredPassword.equals(adminPassword)) {
            isAuthenticated = true;
