...
<body>
    ...
    <%
        ...
        // No password protection for service management
    ...
    <div class="container">
        ...
        <!-- Service Management Content (no password protection) -->
            <div class="card">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <button class="btn btn-edit" onclick="openEditModal('<%= id %>', '<%= name %>', '<%= description.replace("'", "\\'") %>', '<%= price %>', '<%= duration %>', '<%= category %>')"><i class="fas fa-edit"></i></button>
    ...
    <div id="addModal" class="modal">
        <div class="modal-content">
            ...
            <form action="direct-service-management.jsp" method="post">
    ...
    <script>
        ...
        function confirmDelete(id) {
            ...
            confirmBtn.href = 'direct-service-management.jsp?action=delete&id=' + encodeURIComponent(id);
        }
